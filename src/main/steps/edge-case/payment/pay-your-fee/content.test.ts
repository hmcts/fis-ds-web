...
const enContent = {
  ...
  label: 'Paying your adoption application court fees',
  hint: `The application court fees total <span class="govuk-!-font-weight-bold">£183</span>.
  ...
  hintNoFee: `The application court fees total <span class="govuk-!-font-weight-bold">£0</span>.
  <br>If you have little or no savings, receive certain benefits or have a low income you may be able to get help with your application fees.`,
...
const cyContent = {
  ...
  label: 'Paying your adoption application court fees (in welsh)',
  hint: `The application court fees total <span class="govuk-!-font-weight-bold">£183</span> (in welsh).
  ...
  hintNoFee: `The application court fees total <span class="govuk-!-font-weight-bold">£0</span> (in welsh).
  <br>If you have little or no savings, receive certain benefits or have a low income you may be able to get help with your application fees. (in welsh)`,
...
describe('review-pay-submit > payment > pay-your-fee > content', () => {
  let commonContent = generatePageContent({
    language: 'en',
    userCase: {
      applicationFeeOrderSummary: { PaymentTotal: '183', Fees: [] },
      applyingWithAdoption: 'adoption',
      serviceType: 'Yes',
    },
  }) as CommonContent;
  ...
  test('should return correct english yarncontent', () => {
