...
export class PropertiesVolume {
  enableFor(app: Application): void {
    if (!app.locals.developmentMode) {
      ...
      // this.setSecret('secrets.ds.dss-pcq-token', 'services.equalityAndDiversity.tokenKey');
    } else {
      ...
      // this.setLocalSecret('dss-pcq-token', 'services.equalityAndDiversity.tokenKey');
    }
  }
